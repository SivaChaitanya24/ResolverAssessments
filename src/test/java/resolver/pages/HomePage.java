...
public class HomePage {
	...
	// I would prefer to write relative Xpath, written in this way since mentioned
	// in the test to write xpath in the below forment
	...
	public static final By signInButton = By
			.xpath("//*[contains(@class,'form-signin')]//*[contains(@type,'submit') and contains(text(),'Sign in')]");

	// TEST2
	public static final By listgroup = By.xpath(
			"//*[contains(@id,'test-2-div')]//*[contains(@class,'list-group')]/child::*[contains(@class,'group-item')]");
	public static final By badge = By.xpath(
	...
	public static final By successMsg = By.xpath(
